...
* **class fieldOnBoard** - class that was made for fields which are on board. It contains:
...
* **class fieldNextToBoard** - class that was made for fields which are next to board. It contains:
